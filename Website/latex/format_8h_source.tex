...
\hypertarget{format_8h_source}{}\label{format_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/format.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/format.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ PQS\_FORMAT\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ PQS\_FORMAT\_H}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{pqs_8h}{pqs.h}}"{}}}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00052\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_function\_response(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00060\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_directory\_list(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00068\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_file\_list(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00076\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_network\_statistics(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00084\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_process\_list(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00092\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_registry\_list(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00100\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ pqs\_format\_print\_service\_list(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ list,\ \textcolor{keywordtype}{size\_t}\ lstlen,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prompt);}
\DoxyCodeLine{00101\ }
