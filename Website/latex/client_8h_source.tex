...
\hypertarget{client_8h_source}{}\label{client_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/client.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/client.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ PQS\_CLIENT\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ PQS\_CLIENT\_H}}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00085\ PQS\_EXPORT\_API\ \mbox{\hyperlink{pqs_8h_a2c9a6e74f4ff60d25602074a1d70a4e2}{pqs\_errors}}\ \mbox{\hyperlink{client_8h_a3ce3276732b631174b471d95e8f1e1fd}{pqs\_client\_connect\_ipv4}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structpqs__client__verification__key}{pqs\_client\_verification\_key}}*\ pubk,\ }
\DoxyCodeLine{00086\ \ \ \ \ \textcolor{keyword}{const}\ qsc\_ipinfo\_ipv4\_address*\ address,\ uint16\_t\ port,\ }
\DoxyCodeLine{00087\ \ \ \ \ \textcolor{keywordtype}{void}\ (*send\_func)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*),\ }
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordtype}{void}\ (*receive\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*,\ \textcolor{keyword}{const}\ uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00107\ PQS\_EXPORT\_API\ \mbox{\hyperlink{pqs_8h_a2c9a6e74f4ff60d25602074a1d70a4e2}{pqs\_errors}}\ \mbox{\hyperlink{client_8h_a7633f2367ce518b49db644a90807103c}{pqs\_client\_connect\_ipv6}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structpqs__client__verification__key}{pqs\_client\_verification\_key}}*\ pubk,\ }
\DoxyCodeLine{00108\ \ \ \ \ \textcolor{keyword}{const}\ qsc\_ipinfo\_ipv6\_address*\ address,\ uint16\_t\ port,\ }
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keywordtype}{void}\ (*send\_func)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*),\ }
\DoxyCodeLine{00110\ \ \ \ \ \textcolor{keywordtype}{void}\ (*receive\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*,\ \textcolor{keyword}{const}\ uint8\_t*,\ \textcolor{keywordtype}{size\_t}));}
\DoxyCodeLine{00111\ }
