...
\hypertarget{common_8h_source}{}\label{common_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/common.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/common.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#ifndef\ PQS\_MASTER\_COMMON\_H}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#define\ PQS\_MASTER\_COMMON\_H}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00064\ \textcolor{preprocessor}{\#if\ defined(\_DLL)}}
\DoxyCodeLine{00065\ \textcolor{preprocessor}{\#\ \ \ define\ PQS\_DLL\_API}}
\DoxyCodeLine{00066\ \textcolor{preprocessor}{\#endif}\textcolor{preprocessor}{}}
\DoxyCodeLine{00071\ \textcolor{preprocessor}{\#if\ defined(PQS\_DLL\_API)}}
\DoxyCodeLine{00072\ \textcolor{preprocessor}{\#\ \ \ if\ defined(QSC\_SYSTEM\_COMPILER\_MSC)}}
\DoxyCodeLine{00073\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(PQS\_DLL\_IMPORT)}}
\DoxyCodeLine{00074\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_declspec(dllimport)}}
\DoxyCodeLine{00075\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00076\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_declspec(dllexport)}}
\DoxyCodeLine{00077\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00078\ \textcolor{preprocessor}{\#\ \ \ elif\ defined(QSC\_SYSTEM\_COMPILER\_GCC)}}
\DoxyCodeLine{00079\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(PQS\_DLL\_IMPORT)}}
\DoxyCodeLine{00080\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_attribute\_\_((dllimport))}}
\DoxyCodeLine{00081\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00082\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_attribute\_\_((dllexport))}}
\DoxyCodeLine{00083\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00084\ \textcolor{preprocessor}{\#\ \ \ else}}
\DoxyCodeLine{00085\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(\_\_SUNPRO\_C)}}
\DoxyCodeLine{00086\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ if\ !defined(\_\_GNU\_C\_\_)}}
\DoxyCodeLine{00087\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_attribute\_\_\ (visibility(\_\_global))}}
\DoxyCodeLine{00088\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ else}}
\DoxyCodeLine{00089\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_attribute\_\_\ \_\_global}}
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00091\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ elif\ defined(\_MSG\_VER)}}
\DoxyCodeLine{00092\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ extern\ \_\_declspec(dllexport)}}
\DoxyCodeLine{00093\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00094\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ PQS\_EXPORT\_API\ \_\_attribute\_\_\ ((visibility\ ("{}default"{})))}}
...
\DoxyCodeLine{00098\ \textcolor{preprocessor}{\#\ \ \ define\ PQS\_EXPORT\_API}}
\DoxyCodeLine{00099\ \textcolor{preprocessor}{\#endif}\textcolor{preprocessor}{}}
\DoxyCodeLine{00101\ }
