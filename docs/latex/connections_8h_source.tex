...
\hypertarget{connections_8h_source}{}\label{connections_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/connections.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/connections.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ PQS\_CONNECTIONS\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ PQS\_CONNECTIONS\_H}}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00072\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{connections_8h_ac14e503de83952970d83278cf433b3bf}{pqs\_connections\_active}}(\textcolor{keywordtype}{size\_t}\ index);}
\DoxyCodeLine{00073\ }
\DoxyCodeLine{00086\ \mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*\ \mbox{\hyperlink{connections_8h_af2688b2b18b7158e2608dee67a2e7e0d}{pqs\_connections\_add}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00097\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{connections_8h_aad1b3eb01076824c1f2c2465e352ed07}{pqs\_connections\_available}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00098\ }
\DoxyCodeLine{00110\ \mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*\ \mbox{\hyperlink{connections_8h_a78c6e1ad00f14eb4e1ef8e8325e8eed4}{pqs\_connections\_get}}(uint32\_t\ instance);}
\DoxyCodeLine{00111\ }
\DoxyCodeLine{00124\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{connections_8h_a301cb46554f5cc8beeb5264dd92f8f8f}{pqs\_connections\_initialize}}(\textcolor{keywordtype}{size\_t}\ count,\ \textcolor{keywordtype}{size\_t}\ maximum);}
\DoxyCodeLine{00125\ }
\DoxyCodeLine{00133\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{connections_8h_a941d2297399498d702823dc0a5e1f4e2}{pqs\_connections\_clear}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00142\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{connections_8h_aa3c78493e275d50481554117d288cb8a}{pqs\_connections\_dispose}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00155\ \mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*\ \mbox{\hyperlink{connections_8h_a6e0ab567197befed36188b5cf291f383}{pqs\_connections\_index}}(\textcolor{keywordtype}{size\_t}\ index);}
\DoxyCodeLine{00156\ }
\DoxyCodeLine{00166\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{connections_8h_a9bfe8f3968c7aba91e96682113029c2b}{pqs\_connections\_full}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00177\ \mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*\ \mbox{\hyperlink{connections_8h_abc3ea9119fdffde0f4624b1ce426ef95}{pqs\_connections\_next}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00178\ }
\DoxyCodeLine{00188\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{connections_8h_ac34fa08430037985ad4cc4094a513db3}{pqs\_connections\_reset}}(uint32\_t\ instance);}
\DoxyCodeLine{00189\ }
\DoxyCodeLine{00198\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{connections_8h_a69b88619d46ee7888c653a54cb54cf9f}{pqs\_connections\_size}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00199\ }
\DoxyCodeLine{00219\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{connections_8h_a1b11439996c649902ddf104f8a9d903f}{pqs\_connections\_self\_test}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00220\ }
