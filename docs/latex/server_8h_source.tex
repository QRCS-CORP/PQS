...
\hypertarget{server_8h_source}{}\label{server_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/server.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/PQS/PQS/server.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ PQS\_SERVER\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ PQS\_SERVER\_H}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{pqs_8h}{pqs.h}}"{}}}
...
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00069\ \textcolor{preprocessor}{\#define\ PQS\_SERVER\_PAUSE\_INTERVAL\ 100}}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00078\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{server_8h_a464f77940b0c4be43e1f747627c4433f}{pqs\_server\_pause}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00089\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{server_8h_a77be24f2908514353a01634eb3942e48}{pqs\_server\_quit}}(qsc\_socket*\ source);}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00098\ PQS\_EXPORT\_API\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{server_8h_a21ed8451507f44e962e1a24b7d25e5a2}{pqs\_server\_resume}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00115\ PQS\_EXPORT\_API\ \mbox{\hyperlink{pqs_8h_a2c9a6e74f4ff60d25602074a1d70a4e2}{pqs\_errors}}\ \mbox{\hyperlink{server_8h_a08491dc116cdd550407bc040d555cc26}{pqs\_server\_start\_ipv4}}(qsc\_socket*\ source,}
\DoxyCodeLine{00116\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structpqs__server__signature__key}{pqs\_server\_signature\_key}}*\ kset,}
\DoxyCodeLine{00117\ \ \ \ \ \textcolor{keywordtype}{void}\ (*receive\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*,\ \textcolor{keyword}{const}\ uint8\_t*,\ \textcolor{keywordtype}{size\_t}),}
\DoxyCodeLine{00118\ \ \ \ \ \textcolor{keywordtype}{void}\ (*disconnect\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*));}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00135\ PQS\_EXPORT\_API\ \mbox{\hyperlink{pqs_8h_a2c9a6e74f4ff60d25602074a1d70a4e2}{pqs\_errors}}\ \mbox{\hyperlink{server_8h_a40ea87dcbc4b998bb1fab22730713822}{pqs\_server\_start\_ipv6}}(qsc\_socket*\ source,}
\DoxyCodeLine{00136\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structpqs__server__signature__key}{pqs\_server\_signature\_key}}*\ kset,}
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{keywordtype}{void}\ (*receive\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*,\ \textcolor{keyword}{const}\ uint8\_t*,\ \textcolor{keywordtype}{size\_t}),}
\DoxyCodeLine{00138\ \ \ \ \ \textcolor{keywordtype}{void}\ (*disconnect\_callback)(\mbox{\hyperlink{structpqs__connection__state}{pqs\_connection\_state}}*));}
\DoxyCodeLine{00139\ }
